...
public class Main {
    public static class Tree
    {
       ...
       /* void left(BufferedWriter objectForOutputting, )throws Exception{
            Item q = root;
            objectForOutputting.write(q.info);
            objectForOutputting.newLine();

            q.lSon.(objectForOutputting);

        }*/
    }

    /*public static class MyTree extends Tree{
        void left1(BufferedWriter objectForOutputting){
    ...
    public static void main(String[] args) throws Exception{
        ...
        while(buff != null){
            ...
            treeForCommonTask.Insert(number);

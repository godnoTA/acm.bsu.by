...
public class Tree {
	public static final String FILE_INPUT = "tst.in";
	public static final String FILE_OUTPUT = "tst.out";
	static class Node {
		int key;
		Node left;
		Node right;
	...
	public static void main(String args[]){
		...
		try{
			...
			while ((strLine = br.readLine()) != null){
				if(strLine.isEmpty() == true)
					continue;
				tree.insert(Integer.parseInt(strLine));
		...
		if(tree.maxKey != null)
			tree.deleteNode(tree.maxKey);
		//System.out.println("Hello");
		tree.preOrderPrint(FILE_OUTPUT, tree.root);
		System.exit(0);
	}
}